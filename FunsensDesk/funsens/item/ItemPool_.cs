...
namespace funsens.item
{
    public class ItemPool_
    {
        ...
        private ItemPool_(ItemPoolCallback callback)
        {
        ...
        public static ItemPool_ getInstance(ItemPoolCallback callback)
        {
            if (null == instance)
                instance = new ItemPool_(callback);
